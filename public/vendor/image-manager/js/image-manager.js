(function($, window) {
    ...
    window.ImageManager = {
        ...
        afterSelect: function() {
            ...
            }else if(window.ImageManagerCaller.data('multiid') === true)
            {
                window.ImageManager.afterSelectMultiid(window.ImageManagerCaller.data('index'));
            }
            else{
        ...
        afterSelectMultiid: function(index) {
            var source   = $('#multi-image-template'+index).html();
            var template = Handlebars.compile(source);
            var html = template(window.ImageManager.SelectedFile);
            $('#filesContainer'+index).append(html);
            window.ImageManager.SelectedFile = null;
            window.ImageManagerCaller = null;
        }
    };
