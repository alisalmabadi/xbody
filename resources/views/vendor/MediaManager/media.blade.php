...
<head>
    ...
    {{-- Main styles --}}
    <link rel="stylesheet" href="/css/mediamgr.css"/>
...
<body>
                        ...
                        <div class="breadcrumb-container">
                            <ol class="breadcrumb">
                                <li @click="goToFolder(0)">
                                    ...
                                    <a v-if="folders.length > 0" class="p-l-0"><strong>کتابخانه پیام</strong></a>
                                    <p v-else><strong>کتابخانه</strong></p>
                                </li>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="button" data-dismiss="modal">انصراف</button>
                                    <button class="button is-info" id="new_folder_submit">افزودن پوشه جدید</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="move_file_modal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="button" data-dismiss="modal">انصراف</button>
                                    <button class="button is-warning" id="move_btn">برش</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header is-danger">
                                    ...
                                    <h4 class="modal-title">
                                        ...
                                        <span>ایا مطمعنید؟</span>
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    <h4 class="title">ایا میخواهید حذف کنید</h4>
                                    <template v-if="bulkItemsCount">
                                        ...
                                        <template v-else>
                                            <p class="m-l-50">
                                                ...
                                                <span class="title is-4 confirm_delete">چندین فایل</span>
                                            </p>
                                        </template>
                                    </template>
                                ...
                                <div class="modal-footer">
                                    <button class="button" data-dismiss="modal">انصراف</button>
                                    <button class="button is-danger" id="confirm_delete">تایید حذف</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="/js/mediamgr.js"></script>
</body>
</html>
