...
{{--
            <li id="header_inbox_bar" class="dropdown">
                ...
                <ul class="dropdown-menu extended inbox">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('img/avatar1_small.jpg')}}"></span>
                            <span class="subject">
                    ...
                    <li>
                        <a href="#">
                            <span class="photo"><img alt="avatar" src="{{asset('img/picture.png')}}"></span>
                            <span class="subject">
...
--}}
    ...
    <div class="top-nav ">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <img alt="" src="{{asset('img/mini-profile.jpg')}}">
                    <span class="username">{{'سلام '.session()->get("user")['FirstName'].' '.session()->get("user")['LastName']}}</span>
{{--
                    <span class="username">{{'سلام '.$user->first_name.' '.$user->last_name}}</span>
--}}
                ...
                <ul class="dropdown-menu extended logout">
                    ...
                    <li><a href="{{route('user.profile')}}"><i class="icon-suitcase"></i>پروفایل</a></li>
                    <li><a href="{{route('user.reserve')}}"><i class="icon-calendar"></i> رزو کردن</a></li>
                    <li><a href="{{route('user.reserves')}}"><i class="icon-list-alt"></i>رزروهای قبلی</a></li>
