...
@section('content-header')
    <section class="content-header">
        <div class="pull-left">
            <a href="{{route('admin.post.create_bay_cat',$category)}}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="افزودن"><i class="fa fa-plus"></i></a> <a href="{{route('admin.post.show_bay_cat',$category)}}" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="بازسازی"><i class="fa fa-refresh"></i></a>
            ...
            <div class="panel-body">
                <div class="from-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" name="search" id="search" onkeyup="filter_cat($('#search').val(),$('#type').val(),2,{{$category->id}})">

                    </div>
                    <div class="col-sm-3">
                        <label class="control-label" for="resource_id">نوع</label>
                        <select name="type" id="type" onchange="filter_cat($('#search').val(),$('#type').val(),2,{{$category->id}})" class="form-control typesel" >
