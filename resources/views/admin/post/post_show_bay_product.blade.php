...
@section('content-header')
    <section class="content-header">
        <div class="pull-left">
            <a href="{{route('admin.post.create_bay_product',$product)}}" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="افزودن"><i class="fa fa-plus"></i></a> <a href="{{route('admin.post.show_bay_product',$product)}}" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="بازسازی"><i class="fa fa-refresh"></i></a>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-sticky-note"></i>نوشته های</li>
            <li class="active"><i class="fa fa-th"></i>{{$product->name}}</li>
        </ol>
    </section>
@endsection
            ...
            <div class="panel-body">
                <div class="from-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" name="search" id="search" onkeyup="filter_cat($('#search').val(),$('#type').val(),3,{{$product->id}})">

                    </div>
                    <div class="col-sm-3">
                        <label class="control-label" for="resource_id">نوع</label>
                        <select name="type" id="type" onchange="filter_cat($('#search').val(),$('#type').val(),3,{{$product->id}})" class="form-control typesel" >
