    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>ایجاد وضعیت جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.order-state.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}
                        ...
                        <div class="col-sm-3">
                            <select name="type_id" class="select2" id="type_id" style="width: 100%">
                                ...
                                @foreach(order_state_types() as $order_state_type)
                                    <option value="{{$order_state_type->get('id')}}">{{$order_state_type->get('name')}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-3">
                            <select name="class" class="select2" id="class" style="width: 100%">
                                @foreach(order_state_colors() as $color)
                                    <option value="{{$color->get('value')}}"  >{{$color->get('name')}}</option>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <label><input type="radio" checked value="0" name="send_sms">خیر</label>
                            <label><input type="radio" value="1" name="send_sms">بله</label>
                        </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <textarea name="sms_text" id="" cols="30" rows="10"></textarea>
                        </div>
