    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>خصوصیت مقایسه ای جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.comparing.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}

                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="name">نام خصوصیت</label>
                        <div class="col-sm-6">
                            <input id="name" name="name" value="{{old('name')}}" placeholder="نام خصوصیت"  class="form-control" type="text">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <textarea id="desc" name="desc"  placeholder="توضیحات"  class="form-control">{{old('desc')}}</textarea>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <select name="comparing_group_id[]"  style="width: 100%" id="attribute_group_id" class="form-control typeselm" multiple>
                                @foreach($comparing_groups as $comparing_group)
                                    <option value="{{$comparing_group->id}}">{{$comparing_group->name}}</option>
                                @endforeach
                            </select>
