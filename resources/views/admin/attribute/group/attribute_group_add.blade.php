...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-object-group" style="padding: 2px;"></i>گرو های مقایسه ای</li>
    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>گروه مقایسه ای جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.attribute-group.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}

                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="name">نام گروه</label>
                            <div class="col-sm-6">
                                <input id="name" name="name" value="{{old('name')}}" placeholder="نام گروه"  class="form-control" type="text">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <textarea id="desc" name="desc"  placeholder="توضیحات"  class="form-control">{{old('name')}}</textarea>
