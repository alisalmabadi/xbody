    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-plus "></i>خصوصیت جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.attribute.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <select name="attribute_group_id[]"  style="width: 100%" id="attribute_group_id" class="form-control typeselm" multiple>
