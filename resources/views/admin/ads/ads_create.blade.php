...
@section('content-header')
    <section class="content-header">
        <div class="pull-left">
            ...
            <a href="{{route('admin.ads.index')}}" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="لغو"><i class="fa fa-reply"></i></a></div>
        <h1>
            اسلایدر جدید
    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-sliders"></i>افزودن تبلیغات جدید</h3>
            </div>
            <div class="panel-body">
                <form action="{{route('admin.ads.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-name">نام اسلایدر</label>
                        <div class="col-sm-5">
                            <input name="title" value="{{old('title')}}" placeholder="عنوان اسلایدر" id="input-name" class="form-control" type="text">
                            @if($errors->has('title'))
...
--}}
                    <div class="form-group required">
                        ...
                        <div class="col-sm-5">
                            <input name="alt" value="{{old('alt')}}" placeholder="" id="input-name" class="form-control" type="text">
                            @if($errors->has('alt'))
                                <span class="help-block">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-5">
                            <input name="url" value="{{old('url')}}" placeholder="" id="input-name" class="form-control" type="text">
                            @if($errors->has('url'))
                                <span class="help-block">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-5">
                            <input name="order" value="{{old('order')}}" placeholder="" id="input-name" class="form-control" type="text">
                            @if($errors->has('order'))
                                <span class="help-block">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="name">تصویر</label>
                        <div class="col-sm-6">
                            <input id="name" name="image" value="{{old('image')}}"  class="form-control" type="file">
                            @if ($errors->has('image'))
                                <span class="help-block">
                        ...
                        <img src="{{url('/')}}/{{$setting->image}}" width="300" height="100">
