...
@section('content-header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">ویرایش روش ارسال</li>
        </ol>
    </section>
@endsection
    ...
    <section class="content">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{route('admin.delivery.update',$delivery)}}" class="form-horizontal" method="post" enctype="multipart/form-data" id="form-category">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <input id="name" name="name" value="{{$delivery->name}}" placeholder="نام"  class="form-control" type="text" required>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <input id="price" name="price" value="{{$delivery->price}}" placeholder="هزینه"  class="form-control" type="text" required>
                            @if ($errors->has('price'))
                                <span class="help-block">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                ...
                                <input id="free" name="free"  {{$delivery->free? 'checked':''}}  type="checkbox">
                                    </span>
                                <input id="free_price" name="free_price" value="{{$delivery->free_price}}" placeholder="برای خرید بالای (تومان)"  class="form-control" type="text" >
                            </div>
                    ...
                    <div id="valid_dec" class="form-group required">
                        ...
                        <div class="col-sm-6">
                            <textarea id="desc" name="desc" placeholder="اختیاری"  class="form-control" type="text" max="150" >{{$delivery->desc}}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="city_filter_type" id="city_filter_type" class="form-control city-type-sel" required>
                                ...
                                @foreach(city_filter_types() as $type)
                                    <option value="{{$type['id']}}" @if($type['id']==$delivery->city_filter_type) selected="true" @endif >{{$type['name']}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="cities[]" id="cites" class="form-control city-select2" multiple="multiple">
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->id}}" @if(in_array($city->id,array_pluck($delivery->cities,'id'))) selected @endif >{{ $city->name}}</option>
                                @endforeach
                            </select>
