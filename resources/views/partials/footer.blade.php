    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-12 ">
            <div class="item-footer">
                ...
                <div class="footer-body">
                    <p>
                        آدرس : تهران-خیابان بهشتی-کوچه لاله ششم-باشگاه بدن سازی Fitnes 
                    </p>
                    <div class="l-icon">
                        <div class="icon">
                            <div class="icon-2">
...
/*------------------------------- End Footer-Fine-2 -----------------------------*/
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-12 ">
            <div class="item-footer">
                ...
                <div class="footer-body">
                  <p>
                      این نکته را باید در نظر گرفت که بسیاری از کاربران دوست دارند در مورد تاریخچه و چگونگی شروع به کار وبسایت و تجربه‌های کاری اطلاع پیدا کنند اما با
                      ید مطالب این بخش بسیار خلاصه بیان شود و جزئیاتی که بیان آنها ضرورتی ندارد آورده نشود. همچنین در این قسمت باید به کاربران توضیح داد که مزایای این کسب و کار برای کاربران چیست و چه برتری‌
                      هایی
                      نسبت به افراد دیگر در همی
                      ن حوزه کاری دارد. بنابراین توضیحات را با زبان ساده و با اندکی طنز به خوانندگان خود ارائه دهید.
                  </p>
                </div>
            </div>
        </div>
